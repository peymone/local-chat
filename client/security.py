...
class Securuty:
    ...
    def encrypt(self, message: str, server_publicKey: bytes) -> bytes:
        """Encrypt message using server public key"""

        public_key = serialization.load_pem_public_key(server_publicKey)
    ...
    def decrypt(self, encrypted_message: bytes) -> str:
        """Decrypt message using client private key"""
